...
namespace Com.DipoleCat.ExtensionLib.Tests
{
    public class TestRegistries
    {
        ...
        public void TestConsistency()
        {
            ...
            //correct count
            Assert.That(registry.Count, Is.EqualTo(test_values.Count));
                                                             ...
                                                             select (id1, id2))
            {
                ...
                Assert.Multiple(() =>
                {
                    Assert.That(index1, Is.Not.Null);
                    Assert.That(index2, Is.Not.Null);
                    Assert.That(index2, Is.Not.EqualTo(index1));
                });
            }
            ...
            //correct count
            Assert.That(frozen_registry.Count, Is.EqualTo(test_values.Count));
            ...
            foreach (NamespacedId id in test_values)
            {
                ...
                Assert.Multiple(() =>
                {
                    Assert.That(index1, Is.Not.Null);
                    Assert.That(index2, Is.Not.Null);
                    Assert.That(index2, Is.EqualTo(index1));
                });
            }
        }
        ...
        public void TestSerialization()
        {
            ...
            Assert.That(registry2.Count, Is.EqualTo(registry.Count));
